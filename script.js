...
const defaultData = {
    ...
    workExperience: [
        {
            ...
            role: "QC Team Lead",
            duration: "Present",
            description: "Leading the Quality Control team, ensuring high standards across projects."
        }
    ],
    academics: [
        {
    ...
    skills: ["Quality Control", "Team Leadership", "Data Analysis", "Process Optimization"],
    contact: {
        email: "abhi.suru@gmail.com",
        phone: "+91 Enter Phone Number",
